    ...
    public partial class FormLogin : Form
    {
        ...
        public void GetCaja()
        {
                ...
                using (var con = new SqlConnection(conect))
                {
                    ...
                    using (SqlCommand comand = new SqlCommand("SELECT cacodigo as [Id de Caja] from tbcaja where uid = '"+ UserCache.UserID + "' and caestado = 'Abierta' ", con))
                    {
                        ...
                        using (SqlDataReader leer = comand.ExecuteReader())
                        {
                            if (leer.Read() == true)
                            {
                                UserCache.CajaID = leer["Id de Caja"].ToString();
